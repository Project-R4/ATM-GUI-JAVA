...
public class atmBalance extends javax.swing.JFrame {

    /**
     * Creates new form atm Balance
     */
    public atmBalance() {
        initComponents();
        upbal.setText(String.valueOf(bankbal.getBal()));
    }
    
    bankStorage bankbal = bankStorage.getInstance();
    ...
    private void initComponents() {
        ...
        upbal.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        upbal.setForeground(new java.awt.Color(255, 204, 0));
        upbal.setText("0.00");
        jPanel1.add(upbal);
        upbal.setBounds(70, 100, 160, 30);

        Jbackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/BALANCE (1).png"))); // NOI18N
    ...
    private javax.swing.JLabel upbal;
