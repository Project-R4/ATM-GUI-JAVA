...
public class atmTransferCon extends javax.swing.JFrame {


    public atmTransferCon() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(Amount);
        Amount.setBounds(10, 180, 130, 30);

        Jbackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/TRANSFER AMOUNT.png"))); // NOI18N
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
        ...
        double d1 = Double.parseDouble(Amount.getText());
        if(bank.getBal() >= d1){
            double num = bank.getBal() - d1;
            bank.setBal(num);
            ...
            var details = """
                          ...
                          TO Account #: 
                          """ + acc.getAcc()+ "\nAmount: " +d1;
            JOptionPane.showMessageDialog(null,"Successfully Transfered!!","System Message",JOptionPane.PLAIN_MESSAGE,icon);
            JOptionPane.showMessageDialog(null,details,"RECEIPT",JOptionPane.PLAIN_MESSAGE,icon2);
    ...
    private void transferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_transferActionPerformed
        atmTransfer pro1 = new atmTransfer();
        pro1.show();
        dispose();
